...
public class BusTubLimit extends Sort implements BindableRel {
    public BusTubLimit(
            RelOptCluster cluster,
            RelTraitSet traits,
            RelNode child,
            RelCollation collation, @Nullable RexNode fetch) {
    ...
    public Sort copy(RelTraitSet traitSet, RelNode newInput, RelCollation newCollation, @Nullable RexNode offset, @Nullable RexNode fetch) {
        return new BusTubLimit(getCluster(), traitSet, newInput, newCollation, fetch);
    }
